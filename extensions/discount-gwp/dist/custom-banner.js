...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/instructions.mjs
  function useInstructions() {
    return useSubscription(useApi().instructions);
  }

  // extensions/discount-gwp/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const [isDiscountApplied, setIsDiscountApplied] = (0, import_react12.useState)(false);
    const applyCartLinesChange = useApplyCartLinesChange();
    const variantID = "gid://shopify/ProductVariant/46311414300924";
    const lineItem = useCartLines();
    (0, import_react12.useEffect)(() => {
      if (discountCode && discountCode.length > 0 && discountCode[0].code === "NYFW20" && !isDiscountApplied) {
        applyCartLinesChange({
          ...
          attributes: [
            {
              key: "Line Item Property",
              value: "Line Item Property Value"
            }
          ]
        });
        setIsDiscountApplied(true);
      } else if ((!discountCode || discountCode.length === 0 || discountCode[0].code !== "NYFW20") && isDiscountApplied) {
    ...
    if (!instructions.attributes.canUpdateAttributes) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "discount gwp", status: "warning", children: translate("attributeChangesAreNotSupported") });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack, { border: "dotted", padding: "tight", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "discount gwp", children: translate("welcome", {
        target: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text, { emphasis: "italic", children: extension2.target })
      }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox, { onChange: onCheckboxChange, children: translate("iWouldLikeAFreeGiftWithMyOrder") })
    ] });
